...
use crate::bitcoin::tx_utils::{derive_keypair, build_input, build_output, build_transaction, compute_sighash, sign_ecdsa};
...
pub fn redeem_p2wsh_htlc(
    ...
    let htlc_address = generate_p2wsh_address(bitcoin, payment_hash, network)?;
...
mod tests {
    ...
    // Helper to create a mock payment hash
    fn create_mock_payment_hash() -> String {
    ...
    fn test_generate_p2wsh_address_success() {
        ...
        let payment_hash = create_mock_payment_hash();
        let network = KnownHrp::Testnets;

        let result = generate_p2wsh_address(&bitcoin, &payment_hash, network);
    ...
    fn test_refund_taproot_htlc_success() {
        ...
        bitcoin.timelock = 5;
        let payment_hash = "c3a704c5669f96c853fd03521e2318f784e1fe743568fdea9fe3eca2850b3368".to_string();
